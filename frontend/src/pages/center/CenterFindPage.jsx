...
const CenterFindPage = () => {
  ...
  const cityData = {
    ...
    부산광역시: ["중구","서구","동구","영도구","부산진구","동래구","남구","북구","해운대구","사하구","금정구","강서구","연제구","수영구","사상구","기장구"],
    ...
    세종특별자치시: ["세종특별자치시"],
    경기도: ["수원시","용인시","고양시","화성시","성남시","부천시","남양주시","안산시","평택시","안양시","시흥시","파주시","김포시","의정부시","광주시","하남시","광명시","군포시","양주시","오산시","이천시","안성시","구리시","의왕시","포천시","양평군","여주시","동구천시","과천시","가평군","연천군"],
    ...
    경상남도: ["창원시","진주시","통영시","사천시","김해시","밀양시","거제시","양산시","의령군","함안군","창녕군","고성군","남해군","하동군","산청군","함양군","거창군","합천군군"],
    제주특별자치도: ["제주시","서귀포시"]
  };
      ...
      <div className="flex-1 p-8">
        <div className="bg-white rounded-lg shadow-md p-6 h-full flex">
          ...
          <h1 className="text-[1.2rem] font-bold mb-6">
            ...
            <div ref={mapRef} style={{ width: "1350px", height: "500px", border: "1px solid #ddd", borderRadius: "8px", position: "relative", left: "70px",}}></div>

            {/* 헌혈의 집 정보 표시 테이블 */}
            <div 
              className="w-[1500px] mt-2 p-4" 
                ...
                <div className="w-full p-2 rounded-lg shadow">
                  ...
                  <section className="max-h-[150px] overflow-y-auto divide-y divide-gray-200">
                    {filteredCenters.map((center, index) => (
                      ...
                      >
                        <div>{selectedCity} {selectedDistrict}</div>
